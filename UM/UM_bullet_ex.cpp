...
public:
    ...
    inline bool __is_multiple_of(int32_t value) {
...
protected:
    ...
    inline bool flags_allow_kill() {
        return
            !(this->data.is_boss | this->data.__delete_related | this->data.intangible | this->data.no_delete | this->data.only_dialogue_delete) ||
            this->data.always_delete;
    }

public:
    template <bool no_callbacks = false>
    inline void try_kill() {
        if (this->flags_allow_kill()) {
...
struct SoundManager {
    ...
    static inline void __play_sound(int32_t sound_id) {
        SoundManager::__play_sound_centered(sound_id, UNUSED_FLOAT);
    }

    static inline void __play_sound_validate(int32_t sound_id) {
        if (sound_id >= 0) SoundManager::__play_sound(sound_id);
    }

    static inline void __play_sound_positioned_validate(int32_t sound_id, const float& position) {
...
dllexport gnu_noinline void thiscall Gui::__display_stage_logo() {
    if (SUPERVISOR.gamemode_switch != 8 && GAME_MANAGER.__unknown_flag_E) {
        GUI_PTR->stage_logo_anm->instantiate_vm_to_world_list_back(0, -1, NULL);
    }
}
...
dllexport void thiscall AnmID::__sub_488FD0(int32_t script) {
    ...
    if (AnmVM* vm = anm_manager_ptr->get_vm_with_id(*this)) {
        ...
        *this = anm_loaded->instantiate_vm_to_world_list_back(script, -1, NULL);
...
dllexport gnu_noinline BOOL thiscall Globals::__add_power(int32_t value) {
    ...
    if (A > B) {
        ...
        gui->__anm_id_BC = 0;
        gui->__anm_id_BC = gui->__anm_loaded_2C0->instantiate_vm_to_world_list_back(33, -1, NULL);
    }
    int32_t C = (A - value) / this->__power_related_64;
    int32_t D = A / this->__power_related_64;
    return C != D;
        ...
        if (
            ...
            if (
                ...
                if (!Gui::msg_is_active()) {
                    ...
                    if (player->data.__timer_47154 > 0) {
                        return 0;
                    }
...
struct PopupManager : ZUNTask {
    ...
    // 0x4645F0
    dllexport gnu_noinline static int stdcall create_popup(Float3* position, int32_t value, D3DCOLOR color) {
        ...
        if (GAME_THREAD_PTR && this->__unknown_flag_B) {
            ...
            if (A) {
                if (Player* player = PLAYER_PTR) {
                    ...
                    SOUND_MANAGER.__play_sound_positioned(13, PLAYER_PTR->data.position.x);
                }
            }
        }
        return 0;
...
struct CardShinmyoumaru : CardBase {
    ...
    dllexport gnu_noinline virtual int thiscall on_activate() {
        if (!this->__int_54 && this->recharge_time <= 0) {
            ...
            this->__int_54 = 1;
            this->__timer_20.reset();
            SOUND_MANAGER.__play_sound_positioned(30, this->position.x);
        ...
        switch (this->__int_54) {
            ...
            case 2:
                ...
                if (this->__timer_20 > 10) {
                    ...
                    SOUND_MANAGER.__play_sound_positioned(41, this->position.x);
                    this->__timer_20.reset();
...
struct CardTenshi : CardBase {
    ...
    dllexport gnu_noinline virtual int thiscall on_activate() {
        if (!this->__int_54 && this->recharge_time <= 0) {
            ...
            this->__int_54 = 1;
            this->__timer_20.reset();
            SOUND_MANAGER.__play_sound_positioned(77, this->position.x);
            this->__timer_34.set(this->recharge_time * ability_manager_get_float_C58());
            this->__unknown_flag_A = true;
            this->__dword_70 = 0;
        }
        ...
        switch (this->__int_54) {
            case 1:
                ...
                if (
                    ...
                    this->__timer_20.__is_multiple_of(8)
                ) {
                    // TODO
                }
                break;
        ...
        switch (this->__int_54) {
            ...
            case 1:
                ...
                if (this->__timer_20 > 30) {
                    this->__int_54 = 2;
                    this->__timer_20.reset();
                    SOUND_MANAGER.__play_sound_positioned(27, this->position.x);
                }
                break;
            case 0:
                this->__unknown_flag_A = false;
...
struct CardUtsuho : CardBase {
    ...
    dllexport gnu_noinline virtual int thiscall on_activate() {
        if (!this->__int_54 && this->recharge_time <= 0) {
            ...
            this->__int_54 = 1;
            this->__timer_20.reset();
            SOUND_MANAGER.__play_sound_positioned(49, this->position.x);
            this->__timer_34.set(this->recharge_time * ability_manager_get_float_C58());
            this->__dword_64 = 0;
        }
        return 0;
    ...
    dllexport gnu_noinline virtual int thiscall __on_tick_2() {
        switch (this->__int_54) {
            ...
            case 1: {
                ...
                if (
                    this->__timer_20.__is_multiple_of(6) &&
...
struct CardRaiko : CardBase {
    ...
    dllexport gnu_noinline virtual int thiscall on_activate() {
        if (!this->__int_54 && this->recharge_time <= 0) {
            ...
            this->__int_54 = 1;
            this->__timer_20.reset();
            SOUND_MANAGER.__play_sound_positioned(51, this->position.x);
            this->__timer_34.set(this->recharge_time * ability_manager_get_float_C58());
            this->__dword_64 = 0;
        }
        return 0;
    ...
    dllexport gnu_noinline virtual int thiscall on_activate() {
        if (this->__timer_34 <= 0) {
            ...
            if (!bomb_ptr->bomb_active && !bomb_ptr->__dword_A0) {
                ...
                bomb_ptr->__timer_34.reset();
                // TODO
                SOUND_MANAGER.__play_sound_positioned(44, PLAYER_PTR->data.position.x);
                bomb_ptr->activate();
                UNKNOWN_COUNTER_A = 0;
                // ENEMY_MANAGER_PTR->can_capture_spell = FALSE;
    ...
    dllexport static gnu_noinline int32_t count_killable_enemies() asm_symbol_rel(0x42D440) {
        if (auto* enemy_list = ENEMY_MANAGER_PTR->enemy_list_head) {
            return enemy_list->count_if_not([](Enemy* enemy) {
                return enemy->data.disable_hurtbox || enemy->data.invincible || enemy->data.intangible || enemy->data.invulnerable_timer > 0;
            });
        }
        return NULL;
    }
    ...
    inline EnemyID& __get_id_of_nearest_enemy_in_radius(EnemyID& out, Float2* position, float radius) {
        ...
        if (auto* enemy_list = this->enemy_list_head) {
            enemy_list->for_each_safe([&](Enemy* enemy) {
                if (!(
                    enemy->data.disable_hurtbox | enemy->data.intangible |
...
dllexport gnu_noinline int thiscall Enemy::kill() {
    ...
    char* death_callback_sub = this->data.death_callback_sub.name;
    if (death_callback_sub[0]) {
        this->cleanup();
        this->initialize_vm();
        this->set_context_to_sub(death_callback_sub);
        this->run_ecl(0.0f);
    ...
    dllexport virtual gnu_noinline int thiscall check_graze_or_kill(BOOL arg1) override asm_symbol_rel(0x44A950) {
        ...
        if (length > 16.0f) {
            ...
            if (width > 3.0f) {
                ...
                if (result == 2) {
                    if (this->graze_timer.__is_multiple_of(3)) {
                        float C = this->angle;
                        float D;
                        float E;
        ...
        switch (current_type) {
            ...
            case EX_ACCEL: {
                ...
                if (this->effect_index != 0) {
                    SoundManager::__play_sound_validate(this->params.transform_sound);
                }
                break;
            }
            case EX_ANGLE_ACCEL: {
    ...
    while (effect_index < countof(this->effects)) {
        ...
        switch (current_type) {
            ...
            case EX_ACCEL: {
                ...
                effect_data.acceleration_vec.make_from_vector(effect_data.angle, effect_data.acceleration);
                if (this->effect_index != 0) {
                    SoundManager::__play_sound_validate(this->transform_sound);
                }
                break;
            }
            case EX_ANGLE_ACCEL: {
...
inline float EnemyData::kill_effects() {
    SOUND_MANAGER.__play_sound_positioned_validate(this->death_sound, this->current_motion.position.x);
...
dllexport gnu_noinline int32_t thiscall EnemyData::high_ecl_run() {
    ...
    switch (opcode) {
        ...
        case anm_source: // 302
            ...
            break;
        case enemy_flag_mirror: case enemy_flag_mirror2: // 424, 558
        ...
        case anm_create_front_rotated: { // 315
            AnmID id;
            id = ENEMY_MANAGER_PTR->anm_file_lookup(this->get_int_arg(0))->instantiate_vm_to_world_list_front(this->get_int_arg(1), &this->get_current_motion().position, 0.0f);
            AnmVM* vm = id.get_vm_ptr();
            if (vm) {
                vm->set_controller_position(&this->get_current_motion().position);
        ...
        case __effect_create_special: // 334
            EFFECT_MANAGER_PTR->create_effect(this->get_int_arg(0), &this->get_current_motion().position, 0);
            break;
        ...
        case drop_item_rewards_force: // 562
                this->drops.spawn_items(&this->get_current_motion().position);
            }
            break;
        ...
        case boss_set: {
            ...
            if (index < 0) {
                ...
                this->is_boss = true;
                ENEMY_MANAGER_PTR->set_boss(index, (Enemy*)this->vm);
                this->boss_id = index;
            }
            break;
        }
